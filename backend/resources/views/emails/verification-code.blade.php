...
<head>
  ...
  <title>Código de verificación — Congreso Ingenierías 2026</title>
</head>
          ...
          <tr>
            <td style="padding:40px;">
              ...
              <p style="margin:0 0 32px;color:#94a3b8;font-size:14px;line-height:1.6;">
                Usa el siguiente código para verificar tu cuenta en el congreso.
                El código expira en
              ...
              <p style="margin:0;color:#475569;font-size:12px;line-height:1.7;">
                Ingresa este código en la plataforma del congreso para activar tu cuenta.<br>
